...
void run_nn(q15_t* input_data, q15_t* output_data) {
	...
	arm_fully_connected_q15(buffer1, fc1_wt, FC1_IN_DIM, FC1_OUT_DIM, FC1_BIAS_LSHIFT, FC1_OUT_RSHIFT, fc1_bias, buffer2, (q15_t*)col_buffer);
	arm_relu_q15(buffer2, FC1_OUT_DIM);
	arm_fully_connected_q15(buffer2, fc2_wt, FC2_IN_DIM, FC2_OUT_DIM, FC2_BIAS_LSHIFT, FC2_OUT_RSHIFT, fc2_bias, buffer1, (q15_t*)col_buffer);
	arm_relu_q15(buffer1, FC2_OUT_DIM);
	arm_fully_connected_q15(buffer1, fc3_wt, FC3_IN_DIM, FC3_OUT_DIM, FC3_BIAS_LSHIFT, FC3_OUT_RSHIFT, fc3_bias, output_data, (q15_t*)col_buffer);
	}